...
C$    time2=omp_get_wtime()  
      ...
      call bdmk_debug_store_pot(2,nd,npbox,nboxes,pot)
...
C$    time2=omp_get_wtime()  
      ...
      call bdmk_debug_store_proxy(3,ncbox,nd,nboxes,proxycharge)
...
C$    time2 = omp_get_wtime()      
      ...
      call bdmk_debug_store_proxy(6,ncbox,nd,nboxes,proxypotential)
...
C$    time2=omp_get_wtime()  
      ...
      call bdmk_debug_store_pot(7,nd,npbox,nboxes,pot)
...
C$    time2=omp_get_wtime()  
      ...
      call bdmk_debug_store_pot(8,nd,npbox,nboxes,pot)
...
C$    time2=omp_get_wtime()  
      ...
      call bdmk_debug_store_pot(9,nd,npbox,nboxes,pot)
